		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#scttrainingjhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"scttrainingjhoui5-display": {
								"semanticObject": "scttrainingjhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sct.training.jhoui5",
									"url": sap.ui.require.toUrl("sct/training/jhoui5")
								}
							}
						}
					}
